...
export interface LudumOriginalIntroProps {
  game: LudumOriginalGameState;
}

const LudumOriginalIntro: React.FC<LudumOriginalIntroProps> = ({ game }) => {
  ...
  const onContinueClick = useCallback(() => {
    if (tutorialStage < 3) {
      ...
      return dispatch(sendMessage(ludumOriginalAck()));
    }
...
export default LudumOriginalIntro;

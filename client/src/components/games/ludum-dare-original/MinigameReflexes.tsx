...
export interface LudumOriginalMinigameReflexesProps {
  game: LudumOriginalGameState;
  minigame: LudumOriginalMinigameReflexesState;
}

const LudumOriginalMinigameReflexes: React.FC<LudumOriginalMinigameReflexesProps> = ({
  game,
  minigame,
}) => {
...
export default LudumOriginalMinigameReflexes;

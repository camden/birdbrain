        ...
        <section className={styles.list_of_game_cards}>
          {props.showDevGames && (
            <GameCard
              ...
              gameType={GameType.GROVETENDERS}
              onClick={() => props.onPickGame(GameType.GROVETENDERS)}
            />
          )}
          {props.showDevGames && (
            <GameCard
              className={styles.game_card}
              gameType={GameType.SCORE_COUNTER}
              onClick={() => props.onPickGame(GameType.SCORE_COUNTER)}
            />
          )}
          {props.showDevGames && (
            <GameCard
              className={styles.game_card}
              gameType={GameType.SPEEDBOAT}
              onClick={() => props.onPickGame(GameType.SPEEDBOAT)}
            />
          )}
          {props.showDevGames && (
            <GameCard
